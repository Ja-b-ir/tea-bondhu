...
const MEMBERS = [
  {
    ...
    bn: {
      name: "অম্লান জ্যোতি মন্ডল",
      designation: "প্রজেক্ট সুপারভাইজার",
      university: "কম্পিউটার সায়েন্স বিভাগ, প্রাইম বিশ্ববিদ্যালয়",
      bio: "জনাব অম্লান প্রজেক্টের প্রাথমিক পরিকল্পনা থেকে চূড়ান্ত ডিফেন্স পর্যন্ত পুরো যাত্রায় দিকনির্দেশনা দিয়েছেন, টেকনিক্যাল আর্কিটেকচার এবং গবেষণার কাঠামো উভয় ক্ষেত্রেই। তার মতামত দলকে মডেল মূল্যায়নের ক্ষেত্রে আরও কঠোর হতে সাহায্য করেছে।",
  ...
  {
    id: "jabir",
    photo: "/tea-bondhu/founder.jpg",
    isSupervisor: false,
    en: {
      name: "Md Jabir Hossain",
      designation: "ML Engineering & Model Training",
      university: "Final-year CSE Student, Prime University",
    ...
    bn: {
      name: "মোঃ জাবির হোসেন",
      designation: "এমএল ইঞ্জিনিয়ারিং ও মডেল ট্রেনিং",
      university: "ফাইনাল ইয়ার সিএসই শিক্ষার্থী, প্রাইম বিশ্ববিদ্যালয়",
  ...
  },
  {
    ...
    bn: {
      name: "সায়েদা রাফিয়া বারি রিশা",
      designation: "ফ্রন্টএন্ড ও প্রোডাক্ট ডিজাইন",
      university: "ফাইনাল ইয়ার সিএসই শিক্ষার্থী, প্রাইম বিশ্ববিদ্যালয়ের",
